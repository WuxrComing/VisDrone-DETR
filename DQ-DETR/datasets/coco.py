...
def build(image_set, args):
    ...
    if args.dataset_file == 'aitod_v2':
        ...
        # 10 classes
        PATHS = {
            "train": (root / "VisDrone2019-DET-train/images", root / "CocoAnnotation" / 'train.json'),
            "trainval": (root / "VisDrone2019-DET-train/images", root / "CocoAnnotation" / 'train.json'),
            "val": (root / "VisDrone2019-DET-val/images", root / "CocoAnnotation" / 'val.json'),
            "eval_debug": (root / "VisDrone2019-DET-val/images", root / "CocoAnnotation" / 'val.json'),
            "test": (root / "VisDrone2019-DET-test-dev/images", root / "CocoAnnotation" / 'test-dev.json' ),
        }
