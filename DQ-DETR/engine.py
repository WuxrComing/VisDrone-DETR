...
def evaluate(model, criterion, postprocessors, data_loader, base_ds, device, output_dir, wo_class_error=False, args=None, logger=None):
    ...
    if num_images > 0:
        stats['inference_fps'] = num_images / total_inference_time
        stats['inference_ms_per_image'] = (total_inference_time / num_images) * 1000
        stats['num_images_eval'] = num_images
