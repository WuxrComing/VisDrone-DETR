...
| Dome-DETR-M* | HGNetv2-B2 | 0.378 | 0.592 | 0.397 | 0.298 | 0.481 | 0.595 | 0.139 | 0.412 | 0.549 | 15.2 |
...
| Dome-DETR-M* | HGNetv2-B2 | 0.291 | 0.486 | 0.297 | 0.191 | 0.397 | 0.515 | 0.107 | 0.344 | 0.476 | 15.2 |
...
> **说明**: Dome-DETR 的 S / M / L 是尺寸变体（对应 HGNetv2-B0/B2/B4）。`*`表示重新训练后得到的结果。`pretrained` 为上游官方预训练权重。
